...
class GradeAssignment extends Component {
    ...
    componentWillMount() {
        ...
        axios({
            ...
            params: { "assignmentID": id, "courseID": courseID, "studentID": studentID },
                        ...
                        <div className="row justify-content-center align-items-center" >
                            ...
                            <div className="col-12">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-2">
                                    <form onSubmit={this.updateMarks} method="post" style={{margin:"1.3em"}}>
                                    <div className="form-group row">
                                            <div className="col">
                                                <div className="row">
                                                    <label htmlFor="marks">Marks:&nbsp;</label>
                                                <input type="number" className="form-control" name="marks" style={{width:"50%"}} required />
                                                <lable>/10</lable>
                                                </div>
                                            </div>
                                        </div>
