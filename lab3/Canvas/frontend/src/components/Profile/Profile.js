...
class Profile extends Component {
   ...
   async componentDidMount() {
    ...
    updateProfile = async (event) => {
        ...
        let data = {
            "id": id, "role": role, "firstname": formData.get('firstname'),"lastname": formData.get('lastname'), "phoneNumber": formData.get('phoneNumber'),
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="form-group row">
                                                    ...
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="firstname" defaultValue={data.profile.firstname} required readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="name" className="col-sm-2 col-form-label">Last Name:</label>
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="lastname" defaultValue={data.profile.lastname} required readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="phoneNumber" className="col-sm-2 col-form-label">Phone number:</label>
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="phoneNumber" defaultValue={data.profile.phoneNumber} required readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="aboutMe" className="col-sm-2 col-form-label">About Me:</label>
                                                    <div className="col-sm-6">
                                                    <textarea class="form-control" id="aboutMe" name="aboutMe" rows="3" defaultValue={data.profile.aboutMe} readOnly={this.state.readonly} ></textarea>
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="company" className="col-sm-2 col-form-label">Company:</label>
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="company" defaultValue={data.profile.company} readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="city" className="col-sm-2 col-form-label">City:</label>
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="city" defaultValue={data.profile.city} readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="country" className="col-sm-2 col-form-label">Country:</label>
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="country" defaultValue={data.profile.country}  readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="school" className="col-sm-2 col-form-label">School:</label>
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="school" defaultValue={data.profile.school} readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="hometown" className="col-sm-2 col-form-label">Hometown:</label>
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="hometown" defaultValue={data.profile.hometown} readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label htmlFor="languages" className="col-sm-2 col-form-label">Languages:</label>
                                                    <div className="col-sm-6">
                                                        <input type="text" className="form-control" name="languages" defaultValue={data.profile.languages} readOnly={this.state.readonly} />
                                                    </div>
                                                </div>
                                                <div className="form-group row">
...
//Profile = graphql(profilequery, profileQueryOptions)(Profile)
Profile = graphql (updateprofilemutation) (Profile)
